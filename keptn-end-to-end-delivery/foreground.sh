...
# -----------------------------------------#
#    Step 1/10: Installing GitHub CLI      #
# -----------------------------------------#
...
# -----------------------------------------#
#    Step 7/10: Initialising Prometheus    #
# -----------------------------------------#
helm repo add prometheus-community https://prometheus-community.github.io/helm-charts
helm install prometheus prometheus-community/prometheus --namespace monitoring --create-namespace

# -------------------------------------------#
# Step 8/10: Installing Keptn Control Plane  #
# -------------------------------------------#
...
# --------------------------------------------#
# Step 9/10: Installing Job Executor Service  #
# --------------------------------------------#
...
# ---------------------------------------------#
# Step 10/10: Apply Cluster Admin Role for JES #
# ---------------------------------------------#

...
# -----------------------------------------#
#      Step 5/9: Installing Keptn CLI      #
# -----------------------------------------#
curl -sL https://get.keptn.sh | KEPTN_VERSION=$KEPTN_VERSION bash


# -------------------------------------------#
# Step 6/9: Installing Keptn Control Plane   #
# -------------------------------------------#
...
# --------------------------------------------#
# Step 7/9: Installing Job Executor Service   #
# --------------------------------------------#

...
# -----------------------------------------#
#    Step 1️⃣/6️⃣: Initialising Kubernetes...  #
# -----------------------------------------#
...
# ----------------------------------------#
#      Step 2️⃣/6️⃣: Installing Kubectl       #
# ----------------------------------------#
curl -LO https://dl.k8s.io/release/$KUBECTL_VERSION/bin/linux/amd64/kubectl
sudo install -o root -g root -m 0755 kubectl /usr/local/bin/kubectl

# ----------------------------------------#
#         Step 3️⃣/6️⃣: Installing Helm       #
# ----------------------------------------#
...
# -----------------------------------------#
#      Step 4️⃣/6️⃣: Installing Keptn CLI      #
# -----------------------------------------#
curl -sL https://get.keptn.sh | KEPTN_VERSION=$KEPTN_VERSION bash


# -------------------------------------------#
# Step 5️⃣/6️⃣: Installing Keptn Control Plane #
# -------------------------------------------#
...
# --------------------------------------------#
# Step 6️⃣/6️⃣: Installing Job Executor Service #
# --------------------------------------------#
